...
//      이렇게 객체 그래프일 경우에는 얕은 복사를 사용하지 않고 깊은 복사를 통해 immutable의 목적을 달성해야 한다.
      ...
      MyUser original = new MyUser("동석", "한", new Address("강남구", "서울", "대한민국"));
      MyUser shallowCopy = new MyUser(original.getFirstName(), original.getLastName(), original.getAddress());
      MyUser deepCopy = new MyUser(original);
